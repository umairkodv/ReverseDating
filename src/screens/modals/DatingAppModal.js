...
export default function DatingAppModal(props) {
  ...
  return (
    <Modal
      ...
      <View style={styles.modalView}>
        ...
        <Text style={styles.mainText}>{i18n.t('popups.username')}</Text>
        <Text style={styles.contextText}>{i18n.t('popups.match')}</Text>
