...
export const handleAppleLogin = async () => {
  await new Promise(async (resolve, reject) => {
    ...
    console.log('social login function', checkAppleSupport, appleAuth);
    if (checkAppleSupport == true) {
      ...
      console.log('condition', credentialState === appleAuth.State.AUTHORIZED);
